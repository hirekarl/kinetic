  ...
  if (!data) {
    return (
      <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-6 opacity-50">
        ...
        <div className="text-sm text-zinc-500">Brief Kinetic on your sleep or energy levels.</div>
      </div>
    );
  }
  ...
  return (
    <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-6 transition-colors hover:border-zinc-700">
      ...
      <div className="mb-6 grid grid-cols-2 gap-4">
        ...
        <div>
          <div className="text-[10px] uppercase tracking-wider text-zinc-500 mb-1">Sleep Debt</div>
      ...
      <div className="mb-6 p-3 rounded-lg bg-zinc-950/50 border border-zinc-800/50">
        <div className="text-[10px] uppercase tracking-wider text-zinc-500 mb-2">Forecast</div>
